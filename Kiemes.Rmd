...
proportionen <- data.frame(round(prop.table(table(GESIS_panel$fahrrad, GESIS_panel$zufriedenheit)), 4))
...
ggplot(GESIS_panel, aes(x = zufriedenheit, y = fahrrad)) +
  ...
  labs(
    title = "Fahrradnutzung  und Lebenszufriedenheit",
    x = "Zufriedenheit",
    y = "Fahrradnutzung",
    subtitle = "n = 595"
  )
